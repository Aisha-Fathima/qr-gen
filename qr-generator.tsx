...
END:VCARD`
  ...
  const updateNestedQRData = (parent: string, field: string, value: any) => {
    setQRData((prev) => ({
      ...prev,
      [parent]: {
        ...{ ...(prev[parent as keyof QRData] as object) },
        [field]: value,
      },
    }))
  }
  ...
  return (
    <div
      ...
      style={{
        background: `
          linear-gradient(135deg, #f5f5dc 0%, #f0ead6 50%, #ddd5c7 100%)
        `,
        backgroundImage: `
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 text-lg">Create stunning QR codes for different types of content</p>
        </div>

        <div className={`grid gap-8 ${hasValidContent() ? "lg:grid-cols-2" : "lg:grid-cols-1 max-w-2xl mx-auto"}`}>
          {/* Input Section */}
          <Card className="bg-white/95 backdrop-blur-xl border-stone-300 shadow-xl shadow-stone-200/50">
            ...
            <CardContent>
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList className="grid grid-cols-8 mb-6 bg-stone-100 border border-stone-300 p-1">
                  <TabsTrigger
                    value="text"
                    className="data-[state=active]:bg-stone-800 data-[state=active]:text-white text-stone-600 hover:text-black transition-all duration-200"
                  >
                ...
                <TabsContent value="text" className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      className="bg-stone-50 border-stone-300 text-black placeholder:text-gray-500 focus:border-stone-500 focus:ring-stone-500/20"
                      id="text"
                ...
                <TabsContent value="wifi" className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger className="bg-stone-50 border-stone-300 text-black focus:border-stone-500">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
          ...
          {hasValidContent() && (
            <Card className="bg-white/95 backdrop-blur-xl border-stone-300 shadow-xl shadow-stone-200/50">
              ...
              <CardContent className="flex flex-col items-center space-y-4">
                <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-xl shadow-inner border-2 border-stone-200">
                ...
                {qrCodeUrl && (
                  <Button
                    ...
                    className="w-full bg-stone-800 hover:bg-stone-900 text-white font-semibold py-3 shadow-lg hover:shadow-xl transition-all duration-200"
                  >
                ...
                <div className="w-full">
                  ...
                  <div className="mt-2 p-3 bg-stone-50 border border-stone-300 rounded-md text-sm font-mono break-all max-h-32 overflow-y-auto text-gray-700">
                    {generateQRString()}
                  </div>
                </div>
              </CardContent>
